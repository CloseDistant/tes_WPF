            ...
            groups.Add(new TiGroup
            {
                ...
                Channels =
                {
                    new ChannelConfig
                    {
                        ...
                        CurrentMA = TiAlternatingCurrentParameterRules.DefaultPeakCurrentMilliampere,
                        RampUpS = TiAlternatingCurrentParameterRules.DefaultRampUpSeconds,
                        RampDownS = TiAlternatingCurrentParameterRules.DefaultRampDownSeconds,
                        DurationS = TiAlternatingCurrentParameterRules.DefaultTotalDurationSeconds,
                        IntervalS = "0",
                        SingleDurationS = "60",
                        ContinuousTimingPlaceholder = "-",
                        FrequencyHz = TiAlternatingCurrentParameterRules.DefaultFrequencyHz,
                        StimulationMode = "连续",
                        Polarity = "不掉转",
                        AccentBrush = accent
                    },
