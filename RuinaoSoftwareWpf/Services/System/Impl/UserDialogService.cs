...
public sealed class UserDialogService : IUserDialogService
{
    ...
    public PasswordChangeDialogResult? RequestPasswordChange(string? errorMessage = null)
    {
        ...
        return dialog.ShowDialog() == true
            ? new PasswordChangeDialogResult(dialog.NewPassword, dialog.ConfirmPassword)
            : null;
    }
