...
/// <summary>
/// 在旧 IHardwareService 完成迁移前，将纯应用层设备契约单向适配到现有执行链。
/// </summary>
public sealed class LegacyStimulationDeviceGatewayAdapter : IStimulationDeviceGateway
{
    ...
    public LegacyStimulationDeviceGatewayAdapter(
