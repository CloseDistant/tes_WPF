...
public sealed class DirectCurrentStimulationModeModule
    : StimulationModeModuleBase<DirectCurrentControlViewModel>
{
    public DirectCurrentStimulationModeModule(DirectCurrentControlViewModel viewModel)
        : base(StimulationModeCodes.DirectCurrent, viewModel)
    {
