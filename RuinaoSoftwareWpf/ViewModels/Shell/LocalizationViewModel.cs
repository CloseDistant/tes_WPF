...
public sealed class LocalizationViewModel : ObservableObject
{
    ...
    public string TranscranialMonophasicPulseCurrentText => T("TranscranialMonophasicPulseCurrent");
    ...
    public string AlternatingCurrentModeTitleText => T("AlternatingCurrentModeTitle");
    public string PulseCurrentModeTitleText => T("PulseCurrentModeTitle");
    public string MonophasicPulseCurrentModeTitleText => T("MonophasicPulseCurrentModeTitle");
