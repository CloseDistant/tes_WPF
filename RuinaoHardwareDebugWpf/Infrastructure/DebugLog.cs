...
///
/// 日志位置：
/// %USERPROFILE%\Documents\ruinaoLog\RuinaoHardwareDebugWpf\logs
/// </summary>
public static class DebugLog
{
    ...
    private static IEnumerable<string> CandidateLogDirectories()
    {
        ...
        yield return Path.Combine(
            ...
            "Ruinao",
            "RuinaoHardwareDebugWpf",
            "logs");
        yield return Path.Combine(Path.GetTempPath(), "RuinaoHardwareDebugWpf", "logs");
    }
